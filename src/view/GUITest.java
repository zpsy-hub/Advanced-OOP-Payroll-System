...
public class GUITest {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    GUITest window = new GUITest(loggedInEmployee);
     ...
     */
    public GUITest(User loggedInEmployee) {
        GUITest.setLoggedInEmployee(loggedInEmployee);
        initialize();
    }
    ...
    public static void setLoggedInEmployee(User loggedInEmployee) {
        GUITest.loggedInEmployee = loggedInEmployee;
    }
}
