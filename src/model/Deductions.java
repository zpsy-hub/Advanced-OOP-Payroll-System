...
public class Deductions {
	...
	// Constructors   
	public Deductions(double sssContribution, double philhealthContribution, double pagibigContribution, double totalDeductions, double taxableIncome, double withholdingTax) {
