...
public class OG_PayrollSalaryCalculation {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					OG_PayrollSalaryCalculation window = new OG_PayrollSalaryCalculation(loggedInEmployee);
	 ...
	 */
	public OG_PayrollSalaryCalculation(User loggedInEmployee) {
		OG_PayrollSalaryCalculation.loggedInEmployee = loggedInEmployee; 
